    ...
    return (
        <>
            <div className={`productItem ${props.itemView}`} onMouseEnter={() => handleMouseEnter(props?.itemView === 'recentlyView' ? props.item?.prodId : props.item?.id)}
                    ...
                    <Link href={`/product/${props?.itemView === 'recentlyView' ? props.item?.prodId : props.item?.id}`}>

                        {
                            isLoading === true ?
                                ...
                                <Image src={props.item?.images[0]} className="w-100" alt='' layout='responsive' width={0} height={0} />
                        }
                ...
                <div className="info">
                    <Link href={`/product/${props?.itemView === 'recentlyView' ? props.item?.prodId : props.item?.id}`}><h4 onClick={handleclick}>{props?.item?.name?.substr(0, 30) + '...'}</h4></Link>

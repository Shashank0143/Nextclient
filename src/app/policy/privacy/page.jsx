  ...
  return (
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          This Privacy Policy describes how P H BY PRIYANSHU and its affiliates (collectively `&quot;`P H BY
          PRIYANSHU, we, our, us`&quot;`) collect, use, share, protect or otherwise process your information/ personal
          data through our website https://www.phbypriyanshu.com/ (hereinafter referred to as Platform).
        ...
        <p>
          ...
          any information. If you receive an email, a call from a person/association claiming to be P H BY
          PRIYANSHU seeking any personal data like debit/credit card PIN, net-banking or mobile banking
        ...
        <h2>Sharing:</h2>
        <p>We may share your personal data internally within our group entities, our other corporate
        ...
        <p>
          By using the phbypriyanshu website and services, you agree to the

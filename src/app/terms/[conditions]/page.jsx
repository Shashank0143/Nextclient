    ...
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p style={{textAlign:"justify"}}>
          ...
          phbypriyanshu.com/ ( &apos;`Website&apos;`), including the related mobile site and mobile application
          (hereinafter referred to as &apos;`Platform&apos;`).
          <br /><br />
          3. The Platform is owned by P H BY PRIYANSHU, a company incorporated under the Companies
          Act, 1956 with its registered office at SHOP NUMBER TWO, NEAR, AMITY UNIVERSITY
          ROAD, RAIPUR KHADAR NOIDA, Gautam Buddha Nagar, Uttar Prades (hereinafter
          ...
          <br /><br />
          i. To access and use the Services, you agree to provide true, accurate and complete information
          ...
          <br />
          iii. Your use of our Services and the Platform is solely and entirely at your own risk and
          ...
          <br />
          iv. The contents of the Platform and the Services are proprietary to us and are licensed to us.
          ...
          <br />
          v. You acknowledge that unauthorized use of the Platform and/or the Services may lead to
          ...
          <br />
          ix. You understand that upon initiating a transaction for availing the Services you are entering
          ...
          <br />
          xi. Notwithstanding anything contained in these Terms of Use, the parties shall not be liable for
          any failure to perform an obligation under these Terms if performance is prevented or
          delayed by a force majeure event..
          <br />
          xii. These Terms and any dispute or claim relating to it, or its enforceability, shall be governed
          by and construed in accordance with the laws of India..
          <br />
          xiii. All disputes arising out of or in connection with these Terms shall be subject to the exclusive
          jurisdiction of the courts in Bangalore and Karnataka.
          <br />
          xiv. All concerns or communications relating to these Terms must be communicated to us using
